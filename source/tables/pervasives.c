...
{                                                                              
    ...
    MemPtr tySkelBase = (MemPtr)EM_malloc(WORD_SIZE * 326 ); //ts area
...
PERV_ConstData   PERV_constDataTab[PERV_CONST_NUM] = {                         
    ...
    {"%i~",    0,    7,    0,    0,    256,    OP_PREFIX},
    //  addition on integers 
    {"%i+",    0,    8,    0,    0,    150,    OP_INFIXL},
    //  subtraction on integers 
    {"%i-",    0,    8,    0,    0,    150,    OP_INFIXL},
    //  mutiplication on integers 
    {"%i*",    0,    8,    0,    0,    160,    OP_INFIXL},
    //  integer division 
    ...
    //  integer abs 
    {"%iabs",    0,    7,    0,    0,    0,    OP_NONE},
    //  unary minus on real 
    {"%r~",    0,    12,    0,    0,    256,    OP_PREFIX},
    //  addition on reals 
    {"%r+",    0,    14,    0,    0,    150,    OP_INFIXL},
    //  subtraction on reals 
    {"%r-",    0,    14,    0,    0,    150,    OP_INFIXL},
    //  multiplication on reals 
    {"%r*",    0,    14,    0,    0,    160,    OP_INFIXL},
    //  division 
