...
void __CUT__ImplGoalcheck()
{
  EM_TRY
  {
    ...
    TEST_CreateM1ImplGoalTable(inpipe[1]);
    LoadImplGoals(inpipe[0],&m);
    ...
    WriteImplGoals(inpipe[1]);
    TEST_CheckM1ImplGoalTable(inpipe[0]);
